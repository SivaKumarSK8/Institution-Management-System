...
public class DisplayStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Roll Number", "Name", "Standard", "Section", "Mobile Number", "Alternate Mobile No", "Total Fees", "Fees Remaining"
            }
        ));
        ...
        jButton1.setText("Display Student detaiils");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    	...
    	{
    		JOptionPane.showMessageDialog(getParent(), "Please Enter either Roll_No or Name");
    	}
    	else {
    	String name=jTextField1.getText().trim();
    	String rno=jTextField2.getText().trim();
    	try {
    		Connection myConn=DriverManager.getConnection("jdbc:mysql://localhost:3306/school","root","basketball47");
    		
    		Statement stmt= myConn.createStatement();
    		String sql="select roll_no, name,standard,section,mob_no1,mob_no2,total_fees,fees_remaining from student where name like "+"'"+name+"%'"+" or "+"roll_no="+"'"+rno+"'";
    		...
    		while(rs.next())
    		{
    			Object o[]= {rs.getString("roll_no"),rs.getString("name"),rs.getString("standard"),rs.getString("section"),rs.getLong("mob_no1"),rs.getLong("mob_no2"),rs.getInt("total_fees"),rs.getInt("fees_remaining")};
    			dm.addRow(o);
    		}
    	}
    	catch(Exception e)
